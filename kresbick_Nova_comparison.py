# This piece of code represents the comparison between Nova. and Kriesbeck Spectral Density followed by calculation of
...
# =====================
plt.figure("Correlation for OverDamped mode")
plt.plot(t_list, Over_Correlation_R_Kri_list, label="Kri")
plt.plot(t_list, Over_Correlation_R_Nov_list, '--', label="Nov")
plt.xlabel(r'$\tau (fs)$', fontsize=14)
plt.ylabel(r'$\alpha(\tau) (cm-2)$', fontsize=14)
plt.legend()
plt.savefig("/Users/48107674/Box/Reseach/2020/research/simulating_exciton_transport_in_LHCII_aggregates/graphs/Nov"
            "-Kriesbeck_comparison/Correlation_for_OverDamped_mode.png")

plt.figure("Correlation for UnderDamped mode")
plt.plot(t_list, Under_Correlation_R_Nov_list, '--', label="Nov")
plt.plot(t_list, Under_Correlation_R_Kri_list, label="Kri")
plt.xlabel(r'$\tau (fs)$', fontsize=14)
plt.ylabel(r'$\alpha(\tau) (cm-2)$', fontsize=14)
plt.legend()
plt.savefig("/Users/48107674/Box/Reseach/2020/research/simulating_exciton_transport_in_LHCII_aggregates/graphs/Nov"
...
plt.figure("Total Correlation")
plt.plot(t_list, np.array(Over_Correlation_R_Kri_list) + np.array(Under_Correlation_R_Kri_list), label="Kriesbeck")
plt.plot(t_list, np.array(Over_Correlation_R_Nov_list) + np.array(Under_Correlation_R_Nov_list), '--', label="Novod")
plt.legend()
plt.savefig("/Users/48107674/Box/Reseach/2020/research/simulating_exciton_transport_in_LHCII_aggregates/graphs/Nov"
...
plt.plot(omega_list, J_w_array, '--', label="Novod")
plt.plot(omega_list, JK_lst, label="Kriesbeck.")
